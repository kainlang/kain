...
| Packaging metadata | Bundle paths, runtime capabilities, sidecar references | None beyond runtime load hooks | Read packaged sidecars | Invent app-shell structure or runtime workspace identity | Driver emits synthetic runtime snapshot panels/providers/sessions |
...
- Not allowed:
- default topbar or inspector in product mode
