...
{
    DECLARE_GLOBAL_SHADER(FFiniteElementMassShader);
    ...
    {
        TShaderMapRef<FFiniteElementMassShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("FiniteElementMass Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
