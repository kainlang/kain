...
class FFiniteVolumeGradientShader : public FGlobalShader
{
    DECLARE_GLOBAL_SHADER(FFiniteVolumeGradientShader);
    SHADER_USE_PARAMETER_STRUCT(FFiniteVolumeGradientShader, FGlobalShader);
    ...
    {
        TShaderMapRef<FFiniteVolumeGradientShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("FiniteVolumeGradient Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FFiniteVolumeGradientShader, "/Plugin/YourPlugin/FiniteVolumeGradient.usf", "FiniteVolumeGradientCS", SF_Compute);
