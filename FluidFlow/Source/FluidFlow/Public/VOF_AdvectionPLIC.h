...
class FVOF_AdvectionPLICShader : public FGlobalShader
{
    DECLARE_GLOBAL_SHADER(FVOF_AdvectionPLICShader);
    SHADER_USE_PARAMETER_STRUCT(FVOF_AdvectionPLICShader, FGlobalShader);
    ...
    {
        TShaderMapRef<FVOF_AdvectionPLICShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("VOF_AdvectionPLIC Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FVOF_AdvectionPLICShader, "/Plugin/YourPlugin/VOF_AdvectionPLIC.usf", "VOF_AdvectionPLICCS", SF_Compute);
