...
```powershell
.\.agents\skills\lang-blades\scripts\compile_kain_blade_to_root.ps1 -Entry blades\my-blade\src\main.kn -OutputName my-blade.exe -Run
```
...
- Use the `bootstrap-gpu` skill if backend behavior changes.
