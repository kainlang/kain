...
- `src/.rustimport/reference/omni/lib.kn`
...
The capability registry in `crates/core/src/language_features.rs` is the
...
Every top-level item kind defined in `crates/core/src/ast.rs` is covered
here.
...
| --- | --- | --- |
| Interpreter and runtime semantics | `crates/core/src/runtime.rs` | `runtime/runtime-model.md` |
| Builtins and stdlib loading | `crates/core/src/runtime.rs`, `crates/core/src/stdlib.rs` | `runtime/stdlib-and-builtins.md` |
| Effects | `crates/core/src/effects.rs` | `runtime/effects-io-async-and-patching.md` |
| Low-level memory and provenance | `crates/core/src/ast.rs`, `crates/core/src/low_level_memory.rs`, `crates/core/src/low_level_abi.rs` | `syntax-and-semantics/low-level-memory.md`, `native-c-runtime/helper-abi.md` |
| Compiler-owned intents | `crates/core/src/ast.rs`, `crates/core/src/runtime_contract.rs`, `crates/core/src/realtime_app_bundle.rs` | `runtime/compiler-owned-intents.md` |
| Checking, source tests, and proof tests | `crates/check/src/lib.rs`, `crates/test/src/lib.rs`, `stdlib/test.kn`, `crates/cli/src/main.rs` | `cli/check-and-test.md` |
| Runtime contracts and realtime bundles | `crates/core/src/runtime_contract.rs`, `crates/core/src/realtime_app_bundle.rs` | `runtime/runtime-model.md`, `native-c-runtime/abi-contract.md` |
| Native C ABI | `runtime/native/include/*.h` | `native-c-runtime/*.md` |
| Omni orchestration | `src/.rustimport/reference/omni/lib.kn` | `pipelines/omni.md`, `cli/selfhost-omni-fabric-lsp.md` |
| Fabric orchestration | `src/.rustimport/reference/omni/fabric.kn`, `src/.rustimport/reference/host/fabric.kn` | `pipelines/fabric.md`, `cli/selfhost-omni-fabric-lsp.md` |
...
| Compile targets and output families | `crates/core/src/lib.rs`, `crates/driver/src/lib.rs` | `reference/target-matrix.md` |
