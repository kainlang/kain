...
- [ ] 0. Phase 0: Baseline Runtime Audit, Harnesses, and Guardrails
  - [ ] 0.1 Create a runtime completion tracker doc
  ...
  - [ ] 0.2 Establish native runtime validation commands
  ...
  - [ ] 0.3 Create native runtime smoke fixtures
  ...
  - [ ] 0.4 Add a conformance test directory for native runtime behavior
  ...
  - [ ] 0.5 Checkpoint - Baseline can be reproduced
...
- [ ] 1. Phase 1: Canonical ABI, Service Tables, and Version Metadata
  - [ ] 1.1 Define native runtime ABI versioning
  ...
  - [ ] 1.2 Introduce canonical runtime service table headers
