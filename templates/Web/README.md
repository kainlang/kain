...
- runtime APIs for catalog, scene descriptors, forms, search documents, chat, streaming previews, auth, commerce, integrations, data collections, frontend stack, UI runtime, chat runtime, actor runtime, UI schema, and full system contracts
