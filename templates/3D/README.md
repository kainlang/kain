...
- committed generated reflection outputs: [`generated/runtime-reflection`](M:/Templates/3D/generated/runtime-reflection), [`generated/resource-reflection`](M:/Templates/3D/generated/resource-reflection), and [`generated/runtime-compatibility`](M:/Templates/3D/generated/runtime-compatibility)
...
- runtime/schema reflection contracts in [`reflection_runtime.kn`](/mnt/m/Templates/3D/src-kain/stdlib/three_d_runtime/reflection_runtime.kn)
  ...
  with committed launch-profile, build-graph, distribution-receipt, GPU, and runtime-contract reflection snapshots under `generated/runtime-reflection/{launch-profiles,build-graphs,distribution,gpu,contracts}` for bundle and compatibility queries
...
- workspace preset registry and launch export contracts in [`workspace_preset_runtime.kn`](/mnt/m/Templates/3D/src-kain/stdlib/three_d_runtime/workspace_preset_runtime.kn)
...
- committed resource-reflection catalog snapshot in [`generated/resource-reflection/catalog.json`](/mnt/m/Templates/3D/generated/resource-reflection/catalog.json)
- committed resource-reflection descriptor snapshots in [`generated/resource-reflection/descriptors`](/mnt/m/Templates/3D/generated/resource-reflection/descriptors) for descriptor-scoped policy/runtime-link/kernel/contract lookups
...
- committed runtime-compatibility matrix snapshot in [`generated/runtime-compatibility/catalog.json`](/mnt/m/Templates/3D/generated/runtime-compatibility/catalog.json)
...
- committed launch-profile, build-graph, distribution-receipt, GPU, and runtime-contract reflection catalogs at `generated/runtime-reflection/{launch-profiles,build-graphs,distribution,gpu,contracts}` with query indexes/cross-links for preset->receipt and graph<->channel resolution
...
This run deepened the resource reflection surface by expanding the committed catalog shape with richer graph/channel/pipeline/kernel joins and query indexes, while keeping the lane generator-owned and manifest-driven.

It also committed the runtime compatibility matrix lane under `generated/runtime-compatibility`, including descriptor snapshots for matrix/window/readiness lookups plus feature-pack/budget-window tier windows so downstream tools can stay manifest-driven for launch readiness and promotion gating.

What was updated:

- preserved the existing workspace-preset reflection snapshots under [`generated/runtime-reflection/workspace-presets`](/mnt/m/Templates/3D/generated/runtime-reflection/workspace-presets) and [`generated/runtime-reflection/workspace-preset-*`](/mnt/m/Templates/3D/generated/runtime-reflection)
- added committed workspace-preset launch/receipt binding snapshots under [`generated/runtime-reflection/workspace-preset-launch-receipt-bindings`](/mnt/m/Templates/3D/generated/runtime-reflection/workspace-preset-launch-receipt-bindings)
- added committed launch-profile reflection snapshots under [`generated/runtime-reflection/launch-profiles`](/mnt/m/Templates/3D/generated/runtime-reflection/launch-profiles)
- added committed build-graph reflection snapshots under [`generated/runtime-reflection/build-graphs`](/mnt/m/Templates/3D/generated/runtime-reflection/build-graphs)
- added committed distribution-receipt reflection snapshots under [`generated/runtime-reflection/distribution`](/mnt/m/Templates/3D/generated/runtime-reflection/distribution)
- added committed GPU reflection snapshots under [`generated/runtime-reflection/gpu`](/mnt/m/Templates/3D/generated/runtime-reflection/gpu)
- added committed runtime-contract reflection snapshots under [`generated/runtime-reflection/contracts`](/mnt/m/Templates/3D/generated/runtime-reflection/contracts)
- added committed schema reflection snapshots under [`generated/runtime-reflection/schema`](/mnt/m/Templates/3D/generated/runtime-reflection/schema)
- added committed jobs reflection snapshots under [`generated/runtime-reflection/jobs-receipt-schemas`](/mnt/m/Templates/3D/generated/runtime-reflection/jobs-receipt-schemas), [`generated/runtime-reflection/jobs-receipt-templates`](/mnt/m/Templates/3D/generated/runtime-reflection/jobs-receipt-templates), and [`generated/runtime-reflection/jobs-retry-ledgers`](/mnt/m/Templates/3D/generated/runtime-reflection/jobs-retry-ledgers)
- added committed runtime-compatibility snapshots under [`generated/runtime-compatibility`](/mnt/m/Templates/3D/generated/runtime-compatibility)
- expanded runtime-compatibility indexes with `by_feature_pack_tier`, `by_budget_window_tier`, and `by_policy_bundle_id` and added the descriptor snapshot `generated/runtime-compatibility/descriptors/runtime_feature_pack_windows.json`
- expanded `tools/reflection/generate_runtime_reflection_catalogs.ps1` so resource-catalog generation now emits queue/input/output/channel/pipeline/kernels joins and resilient fallback ids
- regenerated [`generated/resource-reflection/catalog.json`](/mnt/m/Templates/3D/generated/resource-reflection/catalog.json) with additional descriptor metadata plus top-level `linked_runtime_contract_entries` and `linked_gpu_catalog_entries`
- added new resource indexes: `by_artifact_root`, `by_build_graph_queue`, `by_distribution_channel_kind`, `by_tensor_pipeline_pass`, `by_kernel_stage`, `by_kernel_tensor_role`, and `by_contract_path`
- updated [`generated/runtime-reflection/README.md`](/mnt/m/Templates/3D/generated/runtime-reflection/README.md), [`generated/resource-reflection/README.md`](/mnt/m/Templates/3D/generated/resource-reflection/README.md), [`ARCHITECTURE.md`](/mnt/m/Templates/3D/ARCHITECTURE.md), and [`MEMORY.md`](/mnt/m/Templates/3D/MEMORY.md) so future runs preserve the deeper resource reflection shape
- bumped [`KAIN.toml`](/mnt/m/Templates/3D/KAIN.toml) to `2.3.15`
