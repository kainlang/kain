...
//
// llvm-kain: ThinLTO/ModuleSummaryIndex support stripped.
// Define LLVM_ENABLE_THINLTO to skip SummaryIndex-dependent code.
#ifndef LLVM_ENABLE_THINLTO
#define LLVM_ENABLE_THINLTO 1
#endif
//===----------------------------------------------------------------------===//
...
#include "core/ir/ModuleSlotTracker.h"
#include "core/ir/ModuleSummaryIndex.h"
#include "core/ir/Operator.h"
#include "core/ir/Type.h"
#include "core/ir/TypeFinder.h"
#include "core/ir/TypedPointerType.h"
#include "core/ir/Use.h"
...
#include "support/adt/FormattedStream.h"
...
// llvm-kain: interleaved range adaptor
namespace llvm {
namespace detail {
template <typename Range>
struct InterleaveRange {
  const Range &R;
  InterleaveRange(const Range &R) : R(R) {}
};
template <typename Range>
raw_ostream &operator<<(raw_ostream &OS, const InterleaveRange<Range> &IR) {
  ListSeparator LS;
  for (const auto &E : IR.R)
    OS << LS << E;
  return OS;
}
} // namespace detail
template <typename Range>
detail::InterleaveRange<Range> interleaved(const Range &R) {
  return detail::InterleaveRange<Range>(R);
}
} // namespace llvm
...
int SlotTracker::processIndex() {
  ST_DEBUG("begin processIndex (stub)!\n");
  // Stub: LTO/ThinLTO summary processing was stripped in Phase 3.
  return TypeIdNext;
}
...
// ModuleSummaryIndex::print/dump provided inline in ModuleSummaryIndex.h stub
...
// ModuleSummaryIndex::dump provided inline in ModuleSummaryIndex.h stub
#endif
