...
private:
  ...
  /// SHL_I32
  static constexpr char RuntimeLibcallImplNameTableStorage[] = "";
  static inline const StringTable RuntimeLibcallImplNameTable =
      StringTable(RuntimeLibcallImplNameTableStorage);
  static constexpr uint16_t RuntimeLibcallNameOffsetTable[54] = {};
  static constexpr uint8_t RuntimeLibcallNameSizeTable[54] = {};

  /// Map from a concrete LibcallImpl implementation to its RTLIB::Libcall kind.
  static constexpr RTLIB::Libcall ImplToLibcall[54] = {};
