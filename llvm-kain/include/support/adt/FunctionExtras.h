...
#include "support/adt/MemAlloc.h"
...
protected:
  ...
  void setOutOfLineStorage(void *Ptr, size_t Size, size_t Alignment) {
    StorageUnion.OutOfLineStorage.StoragePtr = Ptr;
    StorageUnion.OutOfLineStorage.Size = Size;
    StorageUnion.OutOfLineStorage.Alignment = Alignment;
  }
