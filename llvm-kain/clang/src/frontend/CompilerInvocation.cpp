...
#include "frontend/CommandLineSourceLoc.h"
#include "frontend/DependencyOutputOptions.h"
#include "frontend/FrontendOptions.h"
#include "frontend/MigratorOptions.h"
#include "frontend/PreprocessorOutputOptions.h"
#include "frontend/SSAFOptions.h"
...
#include "support/adt/CachedHashString.h"
...
#include "core/frontend/Debug/Options.h"
#include "core/ir/DebugInfoMetadata.h"
#include "core/linker/Linker.h"
#include "core/mc/MCTargetOptions.h"
#include "core/support/Arg.h"
#include "core/support/ArgList.h"
#include "core/support/OptSpecifier.h"
#include "core/support/OptTable.h"
#include "core/support/Option.h"
#include "core/profiledata/InstrProfReader.h"
#include "core/support/HotnessThresholdParser.h"
...
#include "support/adt/ErrorOr.h"
#include "support/adt/FileSystem.h"
#include "support/adt/HashBuilder.h"
...
#include "target/shared/TargetOptions.h"
#include "support/target/Host.h"
...
#define CF_BRANCH_LABEL_SCHEME(Kind, FlagVal)                                  \
  case CFBranchLabelSchemeKind::Kind:                                          \
    ...
    break;
#include "basic/CFProtectionOptions.def"
    }
  }
...
#include "basic/LangStandards.def"
          Diag << NumAliases;
#define LANGSTANDARD(id, name, lang, desc, features, version)
#define LANGSTANDARD_ALIAS(id, alias) \
...
#define ENUM_DEBUGOPT(Name, Type, Bits, Default, Compatibility)                \
  if constexpr (CK::Compatibility != CK::Benign)                               \
    HBuilder.add(static_cast<unsigned>(CodeGenOpts->get##Name()));
#include "basic/DebugOptions.def"
  }
