...
function(tablegen project ofn)
  ...
  # For llvm-kain sandbox: create stub .inc files instead of running tablegen
  # This avoids needing llvm-tblgen / clang-tblgen at configure time
  if(NOT ${project}_TABLEGEN_EXE)
    message(STATUS "tablegen: ${project}_TABLEGEN_EXE not set, creating stub ${ofn}")
    set(full_path "${CMAKE_CURRENT_BINARY_DIR}/${ofn}")
    if(NOT EXISTS "${full_path}")
      file(WRITE "${full_path}" "// Generated stub for llvm-kain sandbox\n")
    endif()
    set(TABLEGEN_OUTPUT ${TABLEGEN_OUTPUT} ${full_path} PARENT_SCOPE)
    set(${project}_TABLEGEN_OUTPUT ${TABLEGEN_OUTPUT} PARENT_SCOPE)
    # Avoid duplicate target names when multiple directories generate the same .inc
    if(NOT TARGET "gen-${ofn}")
      add_custom_target("gen-${ofn}")
    endif()
    return()
  endif()
