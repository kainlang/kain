...
#include "core/object/ELF.h"
#include "support/adt/StringExtras.h"
#include "core/support/ELF.h"
#include "core/object/BBAddrMap.h"
#include "core/object/Decompressor.h"
...
StringRef llvm::object::getELFRelocationTypeName(uint32_t Machine,
  ...
  case ELF::EM_68K:
    switch (Type) {
#include "core/support/ELFRelocs/M68k.def"
    default:
      break;
    }
    break;
  case ELF::EM_X86_64:
    switch (Type) {
#include "core/support/ELFRelocs/x86_64.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_IAMCU:
    switch (Type) {
#include "core/support/ELFRelocs/i386.def"
    default:
      break;
    }
    break;
  case ELF::EM_MIPS:
    switch (Type) {
#include "core/support/ELFRelocs/Mips.def"
    default:
      break;
    }
    break;
  case ELF::EM_AARCH64:
    switch (Type) {
#include "core/support/ELFRelocs/AArch64.def"
    default:
      break;
    }
    break;
  case ELF::EM_ARM:
    switch (Type) {
#include "core/support/ELFRelocs/ARM.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_ARC_COMPACT2:
    switch (Type) {
#include "core/support/ELFRelocs/ARC.def"
    default:
      break;
    }
    break;
  case ELF::EM_AVR:
    switch (Type) {
#include "core/support/ELFRelocs/AVR.def"
    default:
      break;
    }
    break;
  case ELF::EM_HEXAGON:
    switch (Type) {
#include "core/support/ELFRelocs/Hexagon.def"
    default:
      break;
    }
    break;
  case ELF::EM_LANAI:
    switch (Type) {
#include "core/support/ELFRelocs/Lanai.def"
    default:
      break;
    }
    break;
  case ELF::EM_PPC:
    switch (Type) {
#include "core/support/ELFRelocs/PowerPC.def"
    default:
      break;
    }
    break;
  case ELF::EM_PPC64:
    switch (Type) {
#include "core/support/ELFRelocs/PowerPC64.def"
    default:
      break;
    }
    break;
  case ELF::EM_RISCV:
    switch (Type) {
#include "core/support/ELFRelocs/RISCV.def"
    default:
      break;
    }
    break;
  case ELF::EM_S390:
    switch (Type) {
#include "core/support/ELFRelocs/SystemZ.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_SPARCV9:
    switch (Type) {
#include "core/support/ELFRelocs/Sparc.def"
    default:
      break;
    }
    break;
  case ELF::EM_AMDGPU:
    switch (Type) {
#include "core/support/ELFRelocs/AMDGPU.def"
    default:
      break;
    }
    break;
  case ELF::EM_BPF:
    switch (Type) {
#include "core/support/ELFRelocs/BPF.def"
    default:
      break;
    }
    break;
  case ELF::EM_MSP430:
    switch (Type) {
#include "core/support/ELFRelocs/MSP430.def"
    default:
      break;
    }
    break;
  case ELF::EM_VE:
    switch (Type) {
#include "core/support/ELFRelocs/VE.def"
    default:
      break;
    }
    break;
  case ELF::EM_CSKY:
    switch (Type) {
#include "core/support/ELFRelocs/CSKY.def"
    default:
      break;
    }
    break;
  case ELF::EM_LOONGARCH:
    switch (Type) {
#include "core/support/ELFRelocs/LoongArch.def"
    default:
      break;
    }
    break;
  case ELF::EM_XTENSA:
    switch (Type) {
#include "core/support/ELFRelocs/Xtensa.def"
    default:
      break;
    }
    break;
...
#include "core/support/ELFRelocs/RISCV_nonstandard.def"
...
#include "core/support/DynamicTags.def"
