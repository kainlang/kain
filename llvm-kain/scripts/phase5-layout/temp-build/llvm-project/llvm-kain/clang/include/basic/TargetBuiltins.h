...
#include "basic/arm_sve_builtins.inc"
...
#include "basic/BuiltinsAArch64NeonSVEBridge.def"
...
#include "basic/arm_sme_builtins.inc"
...
#include "basic/BuiltinsAArch64.inc"
...
#include "basic/BuiltinsPPC.def"
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsNVPTX.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  }
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsAMDGPU.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  }
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsDirectX.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  } // namespace DirectX
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsSPIRVCommon.inc"
#undef GET_BUILTIN_ENUMERATORS
    FirstVKBuiltin,
    LastCoreBuiltin = FirstVKBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsSPIRVVK.inc"
#undef GET_BUILTIN_ENUMERATORS
    FirstCLBuiltin,
    LastVKBuiltin = FirstCLBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsSPIRVCL.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  } // namespace SPIRV
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsX86.inc"
#undef GET_BUILTIN_ENUMERATORS
    FirstX86_64Builtin,
    LastX86CommonBuiltin = FirstX86_64Builtin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsX86_64.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  }
...
#include "basic/riscv_vector_builtins.inc"
    FirstSiFiveBuiltin,
    LastRVVBuiltin = FirstSiFiveBuiltin - 1,
#include "basic/riscv_sifive_vector_builtins.inc"
    FirstAndesBuiltin,
    LastSiFiveBuiltin = FirstAndesBuiltin - 1,
#include "basic/riscv_andes_vector_builtins.inc"
...
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsRISCV.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  } // namespace RISCV
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define TARGET_BUILTIN(ID, TYPE, ATTRS, FEATURE) BI##ID,
#include "basic/BuiltinsLoongArchBase.def"
    FirstLSXBuiltin,
    LastBaseBuiltin = FirstLSXBuiltin - 1,
#define TARGET_BUILTIN(ID, TYPE, ATTRS, FEATURE) BI##ID,
#include "basic/BuiltinsLoongArchLSX.def"
    FirstLASXBuiltin,
    LastLSXBuiltin = FirstLASXBuiltin - 1,
#define TARGET_BUILTIN(ID, TYPE, ATTRS, FEATURE) BI##ID,
#include "basic/BuiltinsLoongArchLASX.def"
    LastTSBuiltin
  };
  } // namespace LoongArch
...
#include "basic/arm_immcheck_types.inc"
...
#undef LLVM_GET_SVE_MERGETYPES
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsHexagon.inc"
#undef GET_BUILTIN_ENUMERATORS
    LastTSBuiltin
  };
  }
...
#include "basic/BuiltinsXCore.def"
  ...
  namespace SystemZ {
    enum {
        LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define GET_BUILTIN_ENUMERATORS
#include "basic/BuiltinsSystemZ.inc"
#undef GET_BUILTIN_ENUMERATORS
        LastTSBuiltin
    };
  }
