...
#include "basic/arm_sme_builtins_za_state.inc"
...
#include "basic/arm_sme_streaming_attrs.inc"
...
#include "basic/arm_sme_sema_rangechecks.inc"
...
#include "basic/arm_sve_streaming_attrs.inc"
...
#include "basic/arm_sve_sema_rangechecks.inc"
...
bool SemaARM::CheckMVEBuiltinFunctionCall(unsigned BuiltinID,
  ...
  default:
    return false;
#include "basic/arm_mve_builtin_sema.inc"
  }
}
...
bool SemaARM::CheckCDEBuiltinFunctionCall(const TargetInfo &TI,
  ...
  default:
    return false;
#include "basic/arm_cde_builtin_sema.inc"
  }
...
#include "basic/arm_mve_builtin_aliases.inc"
...
#include "basic/arm_cde_builtin_aliases.inc"
  return BuiltinAliasValid(BuiltinID, AliasName, Map, IntrinNames);
}
