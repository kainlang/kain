...
#include "ast/ASTMutationListener.h"
#include "ast/ASTStructuralEquivalence.h"
#include "ast/ASTUnresolvedSet.h"
#include "ast/AbstractTypeReader.h"
#include "ast/Attr.h"
#include "ast/Decl.h"
#include "ast/DeclBase.h"
#include "ast/DeclCXX.h"
#include "ast/DeclFriend.h"
#include "ast/DeclGroup.h"
#include "ast/DeclObjC.h"
#include "ast/DeclTemplate.h"
#include "ast/DeclarationName.h"
#include "ast/Expr.h"
#include "ast/ExprCXX.h"
#include "ast/ExternalASTSource.h"
#include "ast/NestedNameSpecifier.h"
#include "ast/ODRDiagsEmitter.h"
#include "ast/OpenACCClause.h"
#include "ast/OpenMPClause.h"
#include "ast/RawCommentList.h"
#include "ast/TemplateBase.h"
#include "ast/TemplateName.h"
#include "ast/Type.h"
#include "ast/TypeLoc.h"
#include "ast/TypeLocVisitor.h"
#include "ast/UnresolvedSet.h"
#include "basic/ASTSourceDescriptor.h"
#include "basic/CommentOptions.h"
...
#include "basic/ObjCRuntime.h"
#include "basic/OpenACCKinds.h"
#include "basic/OpenMPKinds.h"
#include "basic/OperatorKinds.h"
#include "basic/PragmaKinds.h"
...
#include "lex/HeaderSearch.h"
#include "lex/HeaderSearchOptions.h"
#include "lex/MacroInfo.h"
#include "lex/ModuleMap.h"
#include "lex/PreprocessingRecord.h"
#include "lex/Preprocessor.h"
#include "lex/PreprocessorOptions.h"
#include "lex/Token.h"
#include "sema/ObjCMethodList.h"
#include "sema/Scope.h"
#include "sema/Sema.h"
#include "sema/SemaCUDA.h"
#include "sema/SemaObjC.h"
#include "sema/Weak.h"
#include "serialization/ASTBitCodes.h"
#include "serialization/ASTDeserializationListener.h"
#include "serialization/ASTRecordReader.h"
#include "serialization/ContinuousRangeMap.h"
#include "serialization/GlobalModuleIndex.h"
#include "serialization/InMemoryModuleCache.h"
#include "serialization/ModuleCache.h"
#include "serialization/ModuleFile.h"
#include "serialization/ModuleFileExtension.h"
#include "serialization/ModuleManager.h"
#include "serialization/PCHContainerOperations.h"
#include "serialization/SerializationDiagnostic.h"
#include "support/adt/APFloat.h"
#include "support/adt/APInt.h"
#include "support/adt/ArrayRef.h"
#include "support/adt/DenseMap.h"
#include "support/adt/FoldingSet.h"
#include "support/adt/IntrusiveRefCntPtr.h"
#include "support/adt/STLExtras.h"
#include "support/adt/ScopeExit.h"
#include "support/adt/Sequence.h"
...
#include "support/adt/iterator_range.h"
#include "core/ir/BitstreamReader.h"
#include "support/adt/Compiler.h"
#include "support/adt/Compression.h"
#include "support/adt/DJB.h"
#include "support/adt/Endian.h"
#include "support/adt/Error.h"
#include "support/adt/ErrorHandling.h"
#include "support/adt/LEB128.h"
#include "support/adt/MemoryBuffer.h"
#include "support/adt/Path.h"
#include "support/adt/SaveAndRestore.h"
#include "support/adt/TimeProfiler.h"
#include "support/adt/Timer.h"
...
#include "serialization/TypeBitCodes.def"
  default:
    return std::nullopt;
  }
}
...
#define IMAGE_TYPE(ImgType, Id, SingletonId, Access, Suffix) \
    case PREDEF_TYPE_##Id##_ID: \
      ...
      break;
#include "basic/OpenCLImageTypes.def"
#define EXT_OPAQUE_TYPE(ExtType, Id, Ext) \
    case PREDEF_TYPE_##Id##_ID: \
      T = Context.Id##Ty; \
      break;
#include "basic/OpenCLExtensionTypes.def"
...
#define SVE_TYPE(Name, Id, SingletonId) \
    case PREDEF_TYPE_##Id##_ID: \
      T = Context.SingletonId; \
      break;
#include "basic/AArch64ACLETypes.def"
#define PPC_VECTOR_TYPE(Name, Id, Size) \
    case PREDEF_TYPE_##Id##_ID: \
      T = Context.Id##Ty; \
      break;
#include "basic/PPCTypes.def"
#define RVV_TYPE(Name, Id, SingletonId) \
    case PREDEF_TYPE_##Id##_ID: \
      T = Context.SingletonId; \
      break;
#include "basic/RISCVVTypes.def"
#define WASM_TYPE(Name, Id, SingletonId)                                       \
  case PREDEF_TYPE_##Id##_ID:                                                  \
    T = Context.SingletonId;                                                   \
    break;
#include "basic/WebAssemblyReferenceTypes.def"
#define AMDGPU_TYPE(Name, Id, SingletonId, Width, Align)                       \
  case PREDEF_TYPE_##Id##_ID:                                                  \
    T = Context.SingletonId;                                                   \
    break;
#include "basic/AMDGPUTypes.def"
#define HLSL_INTANGIBLE_TYPE(Name, Id, SingletonId)                            \
  case PREDEF_TYPE_##Id##_ID:                                                  \
    T = Context.SingletonId;                                                   \
    break;
#include "basic/HLSLIntangibleTypes.def"
    }
...
#define BuiltinTemplate(BTName)                                                \
  case PREDEF_DECL##BTName##_ID:                                               \
    ...
    break;
#include "basic/BuiltinTemplates.inc"
...
#define OMP_CLAUSE_NO_CLASS(Enum, Str)                                         \
  case llvm::omp::Enum:                                                        \
    break;
#include "core/frontend/OpenMP/OMPKinds.def"
  default:
    break;
  }
