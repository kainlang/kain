...
pub mod kain_gpu_generated {
    ...
    pub mod editorherosurface {
        ...
        pub const SHADER: ShaderDesc = ShaderDesc { name: "EditorHeroSurface", stage: ShaderStage::Fragment, entry_point: "EditorHeroSurface", output_type: "Vec4", bindings: BINDINGS, };
