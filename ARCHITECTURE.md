...
- `runtime/fixtures/native_ui_runtime_systems/main.kn` is the focused LLVM fixture proving a single Kain file can define a compact UI system over the raw native UI ABI: stable keyed nodes, host presentation, font/texture/canvas/shader handles, text measurement, accessibility metadata, clipboard/IME/drag/menu/dialog state, hot reload generation, and draw submission without runtime-authored widgets.
