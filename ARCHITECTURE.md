...
- [runtime/native/src/core/z3](runtime/native/src/core/z3): durable Z3 proof pack for the native C core runtime. It currently proves actor mailbox/scheduler/supervision arithmetic plus net `Content-Length` and `size_t` append guards through `kain.native.core.proofs`.
