...
- [runtime/native/src/core/z3](runtime/native/src/core/z3): durable Z3 proof pack for the native C core runtime. It now proves actor mailbox/scheduler/supervision arithmetic, net HTTP body-span/allocation guards, process buffer/spec arithmetic, and entangle registry/text-copy bounds through `kain.native.core.proofs`, with focused `actor`, `net`, `process`, `entangle`, `native`, `full`, and workspace `smoke` lanes.
