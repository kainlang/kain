...
- manifest validator: [`scripts/python/validate_3d_template_manifests.py`](M:/Kain/scripts/python/validate_3d_template_manifests.py), which now checks the shared source registry plus engine systems, runtime apps, and workspace presets
