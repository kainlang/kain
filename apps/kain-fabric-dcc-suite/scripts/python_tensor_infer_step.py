...
def run(fabric_inputs):
    ...
    return {
        ...
        "model_path": train_report.get("checkpoint_path", "state/tensor_train_checkpoint.json") if isinstance(train_report, dict) else "state/tensor_train_checkpoint.json",
        "input_uri": "buffer://tensor/features",
        "output_binding": "buffer://tensor/inference/output",
        "output_path": "state/tensor_infer_result.json",
        "dispatch_receipt_path": "state/tensor_infer_dispatch.json",
