...
- The mesh lane now has real Kain-authored projection writers for imported payloads, authored primitives, Catmull-Clark-style subdivision, and UV packing receipts, but those writers are still orchestration-grade contracts rather than persistent mesh normalization or serializer ownership.
