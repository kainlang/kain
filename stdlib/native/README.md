...
- small Kain wrappers for actor, entangle, patch, law, converge, orchestrate, diagnostics, result, collection, runtime, time, net, process, filesystem, input, graphics, and raw UI helpers
