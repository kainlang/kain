...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    body { margin: 0; min-height: 100vh; display: grid; place-items: center; background: ${background}; font-family: Consolas, monospace; color: #f2f6ff; }
    main { width: min(92vw, 1120px); border: 1px solid ${accent}; border-radius: 28px; padding: 18px; background: rgba(8, 10, 18, 0.82); box-shadow: 0 28px 120px rgba(0, 0, 0, 0.48); }
