...
- `config/runtime_policy.json`: repo/env policy, binary lookup order, read limits, skip dirs, and validator runner settings

Source layout:

- `src/main.kn`: MCP router and actor-backed request loop
