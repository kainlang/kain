...
$objectPath = Join-Path $nativeOut "pong_window_bridge.obj"
...
$clangArgs = @(
    ...
    "-I", $nativeRoot,
    (Join-Path $nativeRoot "pong_window_bridge.c"),
    "-o", $objectPath
)

& $Clang @clangArgs
if ($LASTEXITCODE -ne 0) {
    throw "pong window bridge object compilation failed with exit code $LASTEXITCODE"
}

Write-Host "[PASS] Pong window bridge object: $objectPath"
