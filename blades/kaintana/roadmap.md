...
Compile-time capability gating	axiom gates compile the framework for specific targets ___ eliminates dead code for unsupported platforms at compile time
