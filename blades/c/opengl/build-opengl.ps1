...
$objectPath = Join-Path $nativeOut "opengl_bridge.obj"
...
$clangArgs = @(
    ...
    "-I", $nativeRoot,
    (Join-Path $nativeRoot "opengl_bridge.c"),
    "-o", $objectPath
)

& $Clang @clangArgs
if ($LASTEXITCODE -ne 0) {
    throw "opengl bridge object compilation failed with exit code $LASTEXITCODE"
}

Write-Host "[PASS] OpenGL bridge object: $objectPath"
