...
**`py -3 -m kaindev`** - The fast stdlib lookup helper package. New agents should use this before manually opening the huge stdlib atlas. Location: `mcp/kaindev/kain-mcp.py`.
