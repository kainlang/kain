...
fn lower_free_expr_memory(expr: &Expr, target: CompileTarget, _layouts: &LayoutRegistry) -> Expr {
    lower_expr_memory(expr, target)
}
    ...
    match expr {
        ...
        Expr::PtrOffset {
            ...
            vec![
                ...
                Expr::Int(
                    memory_stride_for_type(element_ty.as_ref(), &LayoutRegistry::default())
                        .unwrap_or(1),
                    span,
                ),
            ],
