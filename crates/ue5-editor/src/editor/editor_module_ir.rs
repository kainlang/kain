...
use kain_core::ast::{EditorModuleDef, MenuEntryDef, ToolbarButtonDef, ToolbarWidgetDef, ToolbarPosition};
...
fn convert_toolbar_button(toolbar_button_def: &ToolbarButtonDef) -> Result<ToolbarButtonIR, String> {
    Ok(ToolbarButtonIR {
...
fn convert_toolbar_widget(toolbar_widget_def: &ToolbarWidgetDef) -> Result<ToolbarWidgetIR, String> {
...
mod tests {
    use super::*;
    use kain_core::ast::{EditorModuleDef, MenuEntryDef, ToolbarButtonDef, Function, Block};
