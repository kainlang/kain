...
fn line_endings(_: &RepairProfile) -> bool { true }
fn trailing_whitespace(_: &RepairProfile) -> bool { true }
...
const RULES: [RepairRule; 12] = [
    RepairRule {
        ...
        profile_gate: line_endings, apply: crate::engine::apply_normalize_line_endings,
    },
    RepairRule {
        metadata: RuleMetadata { id: "trim_trailing_whitespace", kind: crate::FixKind::TrimTrailingWhitespace, safety: RuleSafety::Safe, scope: RuleScope::Generic },
        enabled_in_apply_safe: true, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: trailing_whitespace, apply: crate::engine::apply_trim_trailing_whitespace,
    },
    RepairRule {
        metadata: RuleMetadata { id: "collapse_extra_blank_lines", kind: crate::FixKind::CollapseExtraBlankLines, safety: RuleSafety::Safe, scope: RuleScope::Generic },
        enabled_in_apply_safe: true, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: blank_lines, apply: crate::engine::apply_collapse_extra_blank_lines,
    },
    RepairRule {
        metadata: RuleMetadata { id: "close_unterminated_block_comment", kind: crate::FixKind::CloseUnterminatedBlockComment, safety: RuleSafety::Safe, scope: RuleScope::Class },
        enabled_in_apply_safe: true, enabled_in_apply_aggressive: true, enabled_in_dry_run: false, enabled_in_suggest: true,
        profile_gate: block_comments, apply: crate::engine::apply_close_unterminated_block_comment,
    },
    RepairRule {
    ...
    RepairRule {
        ...
        enabled_in_apply_safe: false, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: reserved_identifiers, apply: crate::engine::apply_rewrite_reserved_identifiers,
    },
    RepairRule {
        metadata: RuleMetadata { id: "normalize_self_constructor_syntax", kind: crate::FixKind::NormalizeSelfConstructorSyntax, safety: RuleSafety::Aggressive, scope: RuleScope::Code },
        enabled_in_apply_safe: false, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: self_ctor, apply: crate::engine::apply_normalize_self_constructor_syntax,
    },
    RepairRule {
        metadata: RuleMetadata { id: "rewrite_inline_initializers", kind: crate::FixKind::RewriteInlineInitialization, safety: RuleSafety::Aggressive, scope: RuleScope::ProfileSensitive },
        enabled_in_apply_safe: false, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: inline_initializers, apply: crate::engine::apply_rewrite_inline_initializers,
    },
    RepairRule {
        metadata: RuleMetadata { id: "normalize_namespace_paths", kind: crate::FixKind::NormalizeNamespacePath, safety: RuleSafety::Aggressive, scope: RuleScope::ProfileSensitive },
        enabled_in_apply_safe: false, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: namespace_paths, apply: crate::engine::apply_normalize_namespace_paths,
    },
    RepairRule {
        metadata: RuleMetadata { id: "reconstruct_parser_safe_blocks", kind: crate::FixKind::ReconstructParserSafeBlock, safety: RuleSafety::Aggressive, scope: RuleScope::Code },
        enabled_in_apply_safe: false, enabled_in_apply_aggressive: true, enabled_in_dry_run: true, enabled_in_suggest: true,
        profile_gate: parser_safe_blocks, apply: crate::engine::apply_reconstruct_parser_safe_blocks,
    },
];
