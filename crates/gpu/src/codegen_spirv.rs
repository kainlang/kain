...
fn expr_kind_name(expr: &Expr) -> &'static str {
    match expr {
        ...
        Expr::VolatileLoad { .. } => "VolatileLoad",
        Expr::VolatileStore { .. } => "VolatileStore",
        Expr::AtomicLoad { .. } => "AtomicLoad",
        Expr::AtomicStore { .. } => "AtomicStore",
        Expr::AtomicAdd { .. } => "AtomicAdd",
        Expr::AtomicSub { .. } => "AtomicSub",
        Expr::AtomicAnd { .. } => "AtomicAnd",
        Expr::AtomicOr { .. } => "AtomicOr",
        Expr::AtomicXor { .. } => "AtomicXor",
        Expr::AtomicExchange { .. } => "AtomicExchange",
        Expr::AtomicCompareExchange { .. } => "AtomicCompareExchange",
        Expr::AtomicFence { .. } => "AtomicFence",
        Expr::CpuFence { .. } => "CpuFence",
        Expr::CpuCacheFlush { .. } => "CpuCacheFlush",
