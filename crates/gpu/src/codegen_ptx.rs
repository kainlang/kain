...
pub fn generate_with_options(
    ...
    Ok(generate_variant_modules(program, options, PtxVariantSelection::PrimaryOnly)?
        .into_iter()
        .next()
...
fn render_ptx_module(prepared: &[PreparedPtxShader], target_arch: ModuleArch) -> KainResult<String> {
