...
impl DependencyResolver {
        ...
        if let Some(path) = metadata_path {
            ...
            if path.exists() {
                ...
                let module_map: HashMap<String, Vec<String>> = serde_json::from_str(&content)
                    .map_err(|e| KainError::config_error(format!("Failed to parse engine_modules.json: {}", e)))?;
    ...
    fn build_include_map(_module_map: &HashMap<String, Vec<String>>) -> HashMap<String, Vec<String>> {
    ...
    pub fn default_module_map() -> HashMap<String, Vec<String>> {
        ...
        map.insert("Engine".to_string(), vec!["Core".to_string(), "CoreUObject".to_string()]);
        
        // Rendering modules
        map.insert("RenderCore".to_string(), vec!["Core".to_string()]);
        map.insert("RHI".to_string(), vec!["Core".to_string()]);
        map.insert("Renderer".to_string(), vec!["Core".to_string(), "RenderCore".to_string(), "RHI".to_string()]);
        
        // Slate modules
        map.insert("SlateCore".to_string(), vec!["Core".to_string(), "CoreUObject".to_string()]);
        map.insert("Slate".to_string(), vec!["Core".to_string(), "SlateCore".to_string()]);
        
        // Editor modules
        map.insert("UnrealEd".to_string(), vec!["Core".to_string(), "CoreUObject".to_string(), "Engine".to_string()]);
        map.insert("PropertyEditor".to_string(), vec!["Core".to_string(), "SlateCore".to_string(), "Slate".to_string()]);
        map.insert("AssetTools".to_string(), vec!["Core".to_string(), "UnrealEd".to_string()]);
        map.insert("EditorStyle".to_string(), vec!["Core".to_string(), "SlateCore".to_string()]);
        map.insert("AdvancedPreviewScene".to_string(), vec!["Core".to_string(), "Engine".to_string()]);
        map.insert("ToolMenus".to_string(), vec!["Core".to_string(), "Slate".to_string()]);
        ...
        map.insert("DataTable".to_string(), vec!["Core".to_string(), "CoreUObject".to_string(), "Engine".to_string()]);
    ...
    fn default_include_map() -> HashMap<String, Vec<String>> {
        ...
        map.insert("UObject/Object.h".to_string(), vec!["CoreUObject".to_string()]);
        map.insert("GameFramework/Actor.h".to_string(), vec!["Engine".to_string()]);
        map.insert("Components/ActorComponent.h".to_string(), vec!["Engine".to_string()]);
        
        // Rendering includes
        map.insert("RenderResource.h".to_string(), vec!["RenderCore".to_string()]);
        map.insert("RHI.h".to_string(), vec!["RHI".to_string()]);
        map.insert("GlobalShader.h".to_string(), vec!["RenderCore".to_string()]);
        map.insert("ShaderParameters.h".to_string(), vec!["RenderCore".to_string()]);
        map.insert("ShaderParameterStruct.h".to_string(), vec!["RenderCore".to_string()]);
        
        // Slate includes
        map.insert("Widgets/SCompoundWidget.h".to_string(), vec!["SlateCore".to_string()]);
        map.insert("Widgets/SWidget.h".to_string(), vec!["SlateCore".to_string()]);
        map.insert("Widgets/DeclarativeSyntaxSupport.h".to_string(), vec!["SlateCore".to_string()]);
        map.insert("Widgets/Input/SButton.h".to_string(), vec!["Slate".to_string()]);
        map.insert("Widgets/Text/STextBlock.h".to_string(), vec!["Slate".to_string()]);
        map.insert("Widgets/Layout/SBox.h".to_string(), vec!["Slate".to_string()]);
        
        // Editor includes
        map.insert("Editor.h".to_string(), vec!["UnrealEd".to_string()]);
        map.insert("IDetailCustomization.h".to_string(), vec!["PropertyEditor".to_string()]);
        map.insert("DetailLayoutBuilder.h".to_string(), vec!["PropertyEditor".to_string()]);
        map.insert("DetailCategoryBuilder.h".to_string(), vec!["PropertyEditor".to_string()]);
        map.insert("DetailWidgetRow.h".to_string(), vec!["PropertyEditor".to_string()]);
        map.insert("SEditorViewport.h".to_string(), vec!["UnrealEd".to_string(), "AdvancedPreviewScene".to_string()]);
        map.insert("EditorViewportClient.h".to_string(), vec!["UnrealEd".to_string()]);
        map.insert("AssetEditorToolkit.h".to_string(), vec!["UnrealEd".to_string()]);
        map.insert("ToolMenus.h".to_string(), vec!["ToolMenus".to_string()]);
        map.insert("Framework/Commands/Commands.h".to_string(), vec!["Slate".to_string()]);
        
        // Networking includes
        map.insert("Net/UnrealNetwork.h".to_string(), vec!["Engine".to_string()]);
        map.insert("Engine/NetSerialization.h".to_string(), vec!["Engine".to_string()]);
        
        // DataTable includes
        map.insert("Engine/DataTable.h".to_string(), vec!["Engine".to_string(), "DataTable".to_string()]);
    ...
    fn analyze_file(&self, deps: &mut Dependencies, file_path: &PathBuf, content: &str) -> KainResult<()> {
        ...
        for module in deps.public_modules.iter().chain(deps.private_modules.iter()) {
            ...
            if !self.module_map.contains_key(module) {
                ...
                if self.is_optional_module(module) {
                    eprintln!("Warning: Optional module '{}' not found in module map", module);
                } else {
                    eprintln!("Warning: Module '{}' not found in module map - it may not exist in UE5", module);
                }
            }
    ...
    fn is_optional_module(&self, module: &str) -> bool {
        matches!(module, 
            "AdvancedPreviewScene" | "ToolMenus" | "DataTable" | 
            "NetCore" | "AssetTools" | "PropertyEditor"
        )
    }

    /// Find cycles in module dependencies using DFS, returning the cycle path if found
    fn find_cycle(&self, module: &str, visited: &mut HashSet<String>, rec_stack: &mut HashSet<String>, path: &mut Vec<String>) -> Option<Vec<String>> {
    ...
    pub fn add_automatic_modules(&self, deps: &mut Dependencies, has_shaders: bool, has_slate: bool, has_details: bool, has_viewport: bool, has_asset_editor: bool, has_toolbar: bool, has_networking: bool) {
