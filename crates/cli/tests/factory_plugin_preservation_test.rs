...
fn preservation_all_baseline_behaviors_work() {
    ...
    let tests = vec![
        ...
        ("Components compile", preservation_components_compile as fn()),
        ...
        ("Shader array literals work", preservation_shader_array_literals_work as fn()),
        ("Shader cast expressions work", preservation_shader_cast_expressions_work as fn()),
        ("Shader binding semantics work", preservation_shader_binding_semantics_work as fn()),
        ("UCLASS macros generated", preservation_uclass_macros_generated as fn()),
        ("UPROPERTY macros generated", preservation_uproperty_macros_generated as fn()),
        ("UFUNCTION macros generated", preservation_ufunction_macros_generated as fn()),
        ("USTRUCT macros generated", preservation_ustruct_macros_generated as fn()),
        ("UENUM macros generated", preservation_uenum_macros_generated as fn()),
        ("Stdlib functions available", preservation_stdlib_functions_available as fn()),
        ("Multi-file compilation works", preservation_multi_file_compilation_works as fn()),
    ];
