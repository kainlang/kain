...
impl JSGen {
    ...
    fn gen_program(&mut self, program: &TypedProgram) -> String {
        ...
        self.writeln("function __kain_union_wrap(value, active) { Object.defineProperty(value, '__kain_union_active', { value: active, writable: true, enumerable: false, configurable: true }); return value; }");
        self.writeln("function __kain_union_get(value, field, fallback) { if (value == null) { return fallback; } return value.__kain_union_active === field ? value[field] : fallback; }");
        self.writeln("function __kain_union_set(value, field, next) { if (value != null) { value[field] = next; Object.defineProperty(value, '__kain_union_active', { value: field, writable: true, enumerable: false, configurable: true }); } return next; }");
