...
mod tests {
    ...
    fn test_matrix_types() {
        ...
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("Mat2"),
            Some("float2x2".to_string())
        );
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("Mat3"),
            Some("float3x3".to_string())
        );
        assert_eq!(
    ...
    fn test_texture_types() {
        ...
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("Sampler2D"),
            Some("Texture2D".to_string())
        );
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("Sampler3D"),
            Some("Texture3D".to_string())
        );
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("SamplerCube"),
            Some("TextureCube".to_string())
        );
    }
    ...
    fn test_buffer_types() {
        ...
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("RWBuffer"),
            Some("RWBuffer".to_string())
        );
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("RWTexture2D"),
            Some("RWTexture2D".to_string())
        );
        assert_eq!(
            TYPE_MAPPER.map_to_hlsl("RWTexture3D"),
            Some("RWTexture3D".to_string())
        );
    }
