...
impl Ue5Gen {
    ...
    fn gen_program<P: ProgramItems>(&mut self, program: &P) -> Ue5Output {
        ...
        self.source.push_line("    {");
        self.source.push_line("        FMemory::Memcpy(&Value, &ActiveValue, CopySpan);");
        self.source.push_line("    }");
        self.source.push_line("    return Value;");
        self.source.push_line("}");
        ...
        self.source.push_line("    if (CopySpan > 0)");
        self.source.push_line("    {");
        self.source.push_line("        FMemory::Memcpy(&Result, &Value, CopySpan);");
        self.source.push_line("    }");
        self.source.push_line("    return Result;");
        self.source.push_line("}");
        ...
        self.source.push_line("    {");
        self.source.push_line("        FMemory::Memzero(&Value, ZeroSpan);");
        self.source.push_line("    }");
        self.source.push_line("    const int64 CopySpan = FMath::Min<int64>(FMath::Min<int64>(ByteSize, UnionSize), FMath::Min<int64>(static_cast<int64>(sizeof(TObject)), static_cast<int64>(sizeof(TValue))));");
        self.source.push_line("    if (CopySpan > 0)");
        self.source.push_line("    {");
        self.source.push_line("        FMemory::Memcpy(&Value, &Next, CopySpan);");
        self.source.push_line("    }");
        ...
        self.source.push_line("{");
        self.source.push_line("    if (UnitOffset < 0 || UnitOffset >= static_cast<int64>(sizeof(TObject)))");
        self.source.push_line("    {");
        ...
        self.source.push_line("}");
        self.source.push_line("static uint64 __kain_bitfield_mask(int64 Width)");
        self.source.push_line("{");
        self.source.push_line("    if (Width <= 0) { return 0; }");
        self.source.push_line("    if (Width >= 64) { return MAX_uint64; }");
        self.source.push_line("    return (uint64(1) << Width) - 1ULL;");
        self.source.push_line("}");
        self.source.push_line("static int64 __kain_sign_extend(uint64 Value, int64 Width)");
        self.source.push_line("{");
        self.source.push_line("    if (Width <= 0) { return 0; }");
        self.source.push_line("    if (Width >= 64) { return static_cast<int64>(Value); }");
        self.source.push_line("    const uint64 SignBit = uint64(1) << (Width - 1);");
        self.source.push_line("    if ((Value & SignBit) == 0) { return static_cast<int64>(Value); }");
        self.source.push_line("    const uint64 FullMask = ~__kain_bitfield_mask(Width);");
        self.source.push_line("    return static_cast<int64>(Value | FullMask);");
        self.source.push_line("}");
        ...
        self.source.push_line("{");
        self.source.push_line("    const uint64 Mask = __kain_bitfield_mask(Width);");
        self.source.push_line("    const uint64 Unit = __kain_load_bitfield_unit(Value, UnitOffset);");
        self.source.push_line("    const uint64 Shifted = BitOffset <= 0 ? Unit : (Unit >> BitOffset);");
        self.source.push_line("    const uint64 Encoded = Shifted & Mask;");
        ...
        self.source.push_line("{");
        self.source.push_line("    const uint64 Mask = __kain_bitfield_mask(Width);");
        self.source.push_line("    uint64 Unit = __kain_load_bitfield_unit(Value, UnitOffset);");
        self.source.push_line("    const uint64 Encoded = static_cast<uint64>(static_cast<int64>(Next)) & Mask;");
        self.source.push_line("    const uint64 ShiftedMask = BitOffset <= 0 ? Mask : (Mask << BitOffset);");
        self.source.push_line("    Unit = (Unit & ~ShiftedMask) | (BitOffset <= 0 ? Encoded : (Encoded << BitOffset));");
        self.source.push_line("    __kain_store_bitfield_unit(Value, UnitOffset, Unit);");
