...
impl Ue5Gen {
    ...
    fn gen_program<P: ProgramItems>(&mut self, program: &P) -> Ue5Output {
        ...
        self.source.push_line("}");
        self.source.push_line("template<typename T> T __kain_union_wrap(const T& Value, const TCHAR*)");
        self.source.push_line("{");
        self.source.push_line("    return Value;");
        self.source.push_line("}");
        self.source.push_line("template<typename TObject, typename TValue> TValue __kain_union_get(const TObject&, const TCHAR*, const TValue& Fallback)");
        self.source.push_line("{");
        self.source.push_line("    return Fallback;");
        self.source.push_line("}");
        self.source.push_line("template<typename TObject, typename TValue> TValue __kain_union_set(const TObject&, const TCHAR*, const TValue& Next)");
        self.source.push_line("{");
        self.source.push_line("    return Next;");
        self.source.push_line("}");
        self.source.push_line("template<typename T> int64 __kain_bitfield_get(const T&, const TCHAR*, int64, int64, int64)");
        self.source.push_line("{");
        self.source.push_line("    return 0;");
        self.source.push_line("}");
        self.source.push_line("template<typename TObject, typename TValue> TValue __kain_bitfield_set(const TObject&, const TCHAR*, int64, int64, int64, const TValue& Next)");
        self.source.push_line("{");
        self.source.push_line("    return Next;");
        self.source.push_line("}");
