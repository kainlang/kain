...
fn test_world_position_node() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with world position node"
    );
}
...
fn test_world_normal_node() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with world normal node"
    );
}
...
fn test_absolute_world_position_node() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with absolute world position node"
    );
}
...
fn test_camera_position_node() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with camera position node"
    );
}
...
fn test_object_position_node() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with object position node"
    );
}
...
fn test_object_orientation_node() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with object orientation node"
    );
}
...
fn test_triplanar_sampling() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with triplanar sampling"
    );
}
...
fn test_triplanar_sampling_custom_position() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build material with custom triplanar sampling"
    );
}
...
fn test_world_aligned_texture() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build world-aligned texture material"
    );
}
...
fn test_world_space_procedural_effect() {
    ...
    assert!(
        result.is_ok(),
        "Failed to build procedural world-space effect material"
    );
}
