...
class FQuestAssetEditorModule : public IModuleInterface,
...
private:
	...
	TSharedPtr<struct FQuestNodeFactory> _nodeFactory = nullptr;

	TSharedPtr<class FAssetTypeActions_Base> QuestAssetTypeActions;
	TSharedPtr<class FAssetTypeActions_Base> DialogueMasterQuestTaskAction;
	TSharedPtr<class FAssetTypeActions_Base> DialogueMasterStatisticAction;
