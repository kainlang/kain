...
# buildifier: disable=bzl-visibility
load("//remote_pkgs/crates:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//remote_pkgs/crates:BUILD.bazel"),
        defs_module = Label("//remote_pkgs/crates:defs.bzl"),
    )
