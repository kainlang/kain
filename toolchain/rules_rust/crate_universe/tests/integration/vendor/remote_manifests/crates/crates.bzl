...
# buildifier: disable=bzl-visibility
load("//remote_manifests/crates:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        name = "cvm",
        build_file = Label("//remote_manifests/crates:BUILD.bazel"),
        defs_module = Label("//remote_manifests/crates:defs.bzl"),
    )
