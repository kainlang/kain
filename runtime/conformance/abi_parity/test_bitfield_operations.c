...
#include "../../native/include/bitfield.h"
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
int test_bitfield_get_unsigned(void) {
    ...
    int64_t result = TEST_BITFIELD_GET(
        bf,
        "field_a",
        0,  /* unit_offset */
        0,  /* bit_offset */
...
int test_bitfield_set_unsigned(void) {
    ...
    int64_t returned = TEST_BITFIELD_SET(
        bf,
        "field_a",
        0,  /* unit_offset */
        0,  /* bit_offset */
...
int test_bitfield_width_variations(void) {
    ...
    /* Test 1-bit field */
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "bit1", 0, 0, 1, 0, 32, 1);
    if ((bf.storage & 0x1) != 1) {
    ...
    /* Test 8-bit field */
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "byte", 0, 0, 8, 0, 32, 0xFF);
    ...
    /* Test 16-bit field */
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "short", 0, 0, 16, 0, 32, 0xABCD);
    ...
    /* Test 32-bit field */
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "int", 0, 0, 32, 0, 32, 0x12345678);
...
int test_bitfield_multiple_fields(void) {
    ...
    (void)TEST_BITFIELD_SET(bf, "field_a", 0, 0, 4, 0, 32, 15);

    /* Field B: bits [4:8) = 10 (4 bits) */
    (void)TEST_BITFIELD_SET(bf, "field_b", 0, 4, 4, 0, 32, 10);

    /* Field C: bits [8:16) = 200 (8 bits) */
    (void)TEST_BITFIELD_SET(bf, "field_c", 0, 8, 8, 0, 32, 200);

    /* Verify all fields */
    int64_t val_a = TEST_BITFIELD_GET(bf, "field_a", 0, 0, 4, 0, 32);
    int64_t val_b = TEST_BITFIELD_GET(bf, "field_b", 0, 4, 4, 0, 32);
    int64_t val_c = TEST_BITFIELD_GET(bf, "field_c", 0, 8, 8, 0, 32);
...
int test_bitfield_boundary_values(void) {
    ...
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "max3", 0, 0, 3, 0, 32, 7);
    int64_t result = TEST_BITFIELD_GET(bf, "max3", 0, 0, 3, 0, 32);
    if (result != 7) {
    ...
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "overflow", 0, 0, 3, 0, 32, 8);
    result = TEST_BITFIELD_GET(bf, "overflow", 0, 0, 3, 0, 32);
    if (result != 0) {
    ...
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "max_pos", 0, 0, 3, 1, 32, 3);
    result = TEST_BITFIELD_GET(bf, "max_pos", 0, 0, 3, 1, 32);
    if (result != 3) {
    ...
    bf.storage = 0;
    (void)TEST_BITFIELD_SET(bf, "min_neg", 0, 0, 3, 1, 32, -4);
    result = TEST_BITFIELD_GET(bf, "min_neg", 0, 0, 3, 1, 32);
    if (result != -4) {
...
int test_bitfield_preservation(void) {
    ...
    (void)TEST_BITFIELD_SET(bf, "middle", 0, 8, 8, 0, 32, 0);
