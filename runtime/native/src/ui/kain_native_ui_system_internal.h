...
typedef struct KainNativeUiSession {
    ...
    uint32_t node_index[KAIN_NATIVE_UI_NODE_INDEX_CAPACITY];
    uint32_t stable_key_index[KAIN_NATIVE_UI_STABLE_KEY_INDEX_CAPACITY];
    uint32_t style_index[KAIN_NATIVE_UI_STYLE_INDEX_CAPACITY];
    uint32_t state_index[KAIN_NATIVE_UI_STATE_INDEX_CAPACITY];
    uint32_t resource_index[KAIN_NATIVE_UI_RESOURCE_INDEX_CAPACITY];
    uint32_t menu_index[KAIN_NATIVE_UI_MENU_INDEX_CAPACITY];
    uint32_t dialog_index[KAIN_NATIVE_UI_DIALOG_INDEX_CAPACITY];
    uint64_t node_occupancy_bits[KAIN_NATIVE_UI_NODE_OCCUPANCY_WORD_COUNT];
    uint64_t style_occupancy_bits[KAIN_NATIVE_UI_STYLE_OCCUPANCY_WORD_COUNT];
    uint64_t state_occupancy_bits[KAIN_NATIVE_UI_STATE_OCCUPANCY_WORD_COUNT];
    uint64_t resource_occupancy_bits[KAIN_NATIVE_UI_RESOURCE_OCCUPANCY_WORD_COUNT];
    uint64_t menu_occupancy_bits[KAIN_NATIVE_UI_MENU_OCCUPANCY_WORD_COUNT];
    uint64_t menu_item_occupancy_bits[KAIN_NATIVE_UI_MENU_ITEM_OCCUPANCY_WORD_COUNT];
    uint64_t dialog_occupancy_bits[KAIN_NATIVE_UI_DIALOG_OCCUPANCY_WORD_COUNT];
