...
#if (KAIN_NATIVE_UI_MAX_NODES & (KAIN_NATIVE_UI_MAX_NODES - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_NODES must be a power of two"
#endif
#if (KAIN_NATIVE_UI_MAX_STYLES & (KAIN_NATIVE_UI_MAX_STYLES - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_STYLES must be a power of two"
#endif
#if (KAIN_NATIVE_UI_MAX_STATE & (KAIN_NATIVE_UI_MAX_STATE - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_STATE must be a power of two"
#endif
#if (KAIN_NATIVE_UI_MAX_RESOURCES & (KAIN_NATIVE_UI_MAX_RESOURCES - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_RESOURCES must be a power of two"
#endif
#if (KAIN_NATIVE_UI_MAX_MENUS & (KAIN_NATIVE_UI_MAX_MENUS - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_MENUS must be a power of two"
#endif
#if (KAIN_NATIVE_UI_MAX_MENU_ITEMS & (KAIN_NATIVE_UI_MAX_MENU_ITEMS - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_MENU_ITEMS must be a power of two"
#endif
#if (KAIN_NATIVE_UI_MAX_DIALOGS & (KAIN_NATIVE_UI_MAX_DIALOGS - 1)) != 0
#error "KAIN_NATIVE_UI_MAX_DIALOGS must be a power of two"
#endif

#define KAIN_NATIVE_UI_NODE_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_NODES
#define KAIN_NATIVE_UI_NODE_INDEX_MASK (KAIN_NATIVE_UI_NODE_INDEX_CAPACITY - 1u)
#define KAIN_NATIVE_UI_STABLE_KEY_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_NODES
#define KAIN_NATIVE_UI_STABLE_KEY_INDEX_MASK (KAIN_NATIVE_UI_STABLE_KEY_INDEX_CAPACITY - 1u)
#define KAIN_NATIVE_UI_STYLE_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_STYLES
#define KAIN_NATIVE_UI_STYLE_INDEX_MASK (KAIN_NATIVE_UI_STYLE_INDEX_CAPACITY - 1u)
#define KAIN_NATIVE_UI_STATE_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_STATE
#define KAIN_NATIVE_UI_STATE_INDEX_MASK (KAIN_NATIVE_UI_STATE_INDEX_CAPACITY - 1u)
#define KAIN_NATIVE_UI_RESOURCE_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_RESOURCES
#define KAIN_NATIVE_UI_RESOURCE_INDEX_MASK (KAIN_NATIVE_UI_RESOURCE_INDEX_CAPACITY - 1u)
#define KAIN_NATIVE_UI_MENU_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_MENUS
#define KAIN_NATIVE_UI_MENU_INDEX_MASK (KAIN_NATIVE_UI_MENU_INDEX_CAPACITY - 1u)
#define KAIN_NATIVE_UI_DIALOG_INDEX_CAPACITY KAIN_NATIVE_UI_MAX_DIALOGS
#define KAIN_NATIVE_UI_DIALOG_INDEX_MASK (KAIN_NATIVE_UI_DIALOG_INDEX_CAPACITY - 1u)

#define KAIN_NATIVE_UI_NODE_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_NODES / 64u)
#define KAIN_NATIVE_UI_STYLE_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_STYLES / 64u)
#define KAIN_NATIVE_UI_STATE_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_STATE / 64u)
#define KAIN_NATIVE_UI_RESOURCE_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_RESOURCES / 64u)
#define KAIN_NATIVE_UI_MENU_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_MENUS / 64u)
#define KAIN_NATIVE_UI_MENU_ITEM_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_MENU_ITEMS / 64u)
#define KAIN_NATIVE_UI_DIALOG_OCCUPANCY_WORD_COUNT (KAIN_NATIVE_UI_MAX_DIALOGS / 64u)
