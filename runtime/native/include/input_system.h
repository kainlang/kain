#ifndef ABI_INPUT_SYSTEM_H
#define ABI_INPUT_SYSTEM_H
...
#define ABI_INPUT_MAX_SESSIONS 16
#define ABI_INPUT_MAX_BINDINGS 512
#define ABI_INPUT_MAX_EVENTS 1024
#define ABI_INPUT_MAX_ACTIONS 256
#define ABI_INPUT_MAX_AXES 128
#define ABI_INPUT_MAX_TEXT_COMMITS 256
#define ABI_INPUT_MAX_TEXT 256
#define ABI_INPUT_MAX_KEY 96
#define ABI_INPUT_MAX_TRACE_TEXT 65536

typedef enum KainNativeInputStatus {
    ABI_INPUT_OK = 0,
    ABI_INPUT_INVALID_SESSION = -1,
    ABI_INPUT_CAPACITY_EXCEEDED = -2,
    ABI_INPUT_INVALID_ARGUMENT = -3,
