...
#define KAIN_UI_HOT_RELOAD_CHANNEL_ENV "KAIN_NATIVE_UI_HOT_RELOAD_CHANNEL"
#define KAIN_UI_HOT_RELOAD_POLL_INTERVAL_ENV "KAIN_NATIVE_UI_HOT_RELOAD_POLL_INTERVAL_MS"
