...
NATIVE_CORE_RUNTIME = {
    ...
    "common_c_srcs": [
        ...
        'native/src/ui_v2/kaintana_arena.c',
        'native/src/ui_v2/attr_table.c',
        'native/src/ui_v2/box_math.c',
        'native/src/ui_v2/color.c',
        'native/src/ui_v2/damage.c',
        'native/src/ui_v2/draw_pixels.c',
        'native/src/ui_v2/hash_table.c',
        'native/src/ui_v2/tree.c',
