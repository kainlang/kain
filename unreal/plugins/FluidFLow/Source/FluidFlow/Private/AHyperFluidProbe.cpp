...
void AHyperFluidProbe::Tick(float DeltaTime)
{
	...
	void AHyperFluidProbe::Server_Sample_Implementation(const HyperFluidWorld world)
	{
		buffer = hyperfluid_sample_field(world, sample_position, radius);
		Client_ReceiveSample(buffer);
	}

	bool AHyperFluidProbe::Server_Sample_Validate(const HyperFluidWorld world)
	{
