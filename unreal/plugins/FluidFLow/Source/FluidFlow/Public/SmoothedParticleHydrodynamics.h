...
// IMPLEMENT_GLOBAL_SHADER(FSmoothedParticleHydrodynamicsShader, "/Plugin/YourPlugin/SmoothedParticleHydrodynamics.usf", "SmoothedParticleHydrodynamicsCS", SF_Compute);
