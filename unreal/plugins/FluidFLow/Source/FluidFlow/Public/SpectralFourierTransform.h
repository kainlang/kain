...
class FSpectralFourierTransformShader : public FGlobalShader
{
    DECLARE_GLOBAL_SHADER(FSpectralFourierTransformShader);
    SHADER_USE_PARAMETER_STRUCT(FSpectralFourierTransformShader, FGlobalShader);
    ...
    {
        TShaderMapRef<FSpectralFourierTransformShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("SpectralFourierTransform Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FSpectralFourierTransformShader, "/Plugin/YourPlugin/SpectralFourierTransform.usf", "SpectralFourierTransformCS", SF_Compute);
