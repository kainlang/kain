...
class FVortexMethodAdvectionShader : public FGlobalShader
{
    DECLARE_GLOBAL_SHADER(FVortexMethodAdvectionShader);
    SHADER_USE_PARAMETER_STRUCT(FVortexMethodAdvectionShader, FGlobalShader);
    ...
    {
        TShaderMapRef<FVortexMethodAdvectionShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("VortexMethodAdvection Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FVortexMethodAdvectionShader, "/Plugin/YourPlugin/VortexMethodAdvection.usf", "VortexMethodAdvectionCS", SF_Compute);
