...
class FViscoelasticStressShader : public FGlobalShader
{
    ...
    {
        TShaderMapRef<FViscoelasticStressShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("ViscoelasticStress Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FViscoelasticStressShader, "/Plugin/YourPlugin/ViscoelasticStress.usf", "ViscoelasticStressCS", SF_Compute);
