...
{
    DECLARE_GLOBAL_SHADER(FVortexMethodCoreShader);
    SHADER_USE_PARAMETER_STRUCT(FVortexMethodCoreShader, FGlobalShader);
    ...
    {
        TShaderMapRef<FVortexMethodCoreShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("VortexMethodCore Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FVortexMethodCoreShader, "/Plugin/YourPlugin/VortexMethodCore.usf", "VortexMethodCoreCS", SF_Compute);
