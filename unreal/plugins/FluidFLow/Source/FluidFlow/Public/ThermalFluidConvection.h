...
{
    DECLARE_GLOBAL_SHADER(FThermalFluidConvectionShader);
    ...
    {
        TShaderMapRef<FThermalFluidConvectionShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("ThermalFluidConvection Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
