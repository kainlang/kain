...
class FViscoelasticRelaxationShader : public FGlobalShader
{
    DECLARE_GLOBAL_SHADER(FViscoelasticRelaxationShader);
    SHADER_USE_PARAMETER_STRUCT(FViscoelasticRelaxationShader, FGlobalShader);
    ...
    {
        TShaderMapRef<FViscoelasticRelaxationShader> ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
        ...
        *PassParameters = Parameters;
        ...
        FComputeShaderUtils::AddPass(
            GraphBuilder,
            RDG_EVENT_NAME("ViscoelasticRelaxation Dispatch"),
            ComputeShader,
            PassParameters,
            GroupCount
        );
...
// IMPLEMENT_GLOBAL_SHADER(FViscoelasticRelaxationShader, "/Plugin/YourPlugin/ViscoelasticRelaxation.usf", "ViscoelasticRelaxationCS", SF_Compute);
