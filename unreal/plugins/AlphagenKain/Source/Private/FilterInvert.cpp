...
namespace {
    ...
    static FShaderDirectoryRegistration GShaderDirReg_FilterInvert;
}

// Register shader with UE5
IMPLEMENT_GLOBAL_SHADER(FFilterInvertShader, "/Plugin/AlphaGen/Shaders/FilterInvert.usf", "FilterInvertCS", SF_Compute);
