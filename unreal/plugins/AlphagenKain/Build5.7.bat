...
echo [ENGINE] Unreal Engine 5.7 ONLY

REM Define Output Directory
set "OUTPUT_ROOT=%SCRIPT_DIR%\_Builds"

REM ==============================================================================
REM [PATH] YOUR 5.7 INSTALL LOCATION
REM ==============================================================================
...
if exist "%UE_5_7%\Engine\Build\BatchFiles\RunUAT.bat" (
    echo.
    echo -----------------------------------------------------------------------
    echo [BUILDING] %PLUGIN_NAME% for UE 5.7...
    echo -----------------------------------------------------------------------
    ...
    echo [CHECK] Look inside: %OUTPUT_ROOT%\%PLUGIN_NAME%_5.7
) else (
    echo [ERROR] Could not find UE 5.7 at: %UE_5_7%
